...
export const siteConfig = {
    ...
    pricing: {
        ...
        description:
            "KubeClaw is free, but keeping the servers (and the AI agent) running costs money. If you find this project useful, consider supporting the developer.",
        pricingItems: [
            {
                ...
                description: "Help Kane keep KubeClaw and Pi running.",
                buttonText: "See Addresses Below",
